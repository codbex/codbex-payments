...
const dao = require("codbex-payments/gen/dao/entities/Product");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-payments/gen/api/Product.js/" + entity.Id);
