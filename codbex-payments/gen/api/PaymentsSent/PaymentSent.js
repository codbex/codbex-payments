...
const dao = require("codbex-payments/gen/dao/PaymentsSent/PaymentSent");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-payments/gen/api/PaymentSent.js/" + entity.Id);
