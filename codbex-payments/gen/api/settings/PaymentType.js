...
const dao = require("codbex-payments/gen/dao/settings/PaymentType");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-payments/gen/api/PaymentType.js/" + entity.Id);
