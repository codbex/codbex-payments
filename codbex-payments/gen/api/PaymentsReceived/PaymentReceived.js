...
const dao = require("codbex-payments/gen/dao/PaymentsReceived/PaymentReceived");
...
rs.service()
	...
	.resource("{id}")
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound("PaymentReceived not found");
			}
		})
		.produces(["application/json"])
		.catch(function(ctx, error) {
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-payments/gen/api/PaymentReceived.js/" + entity.Id);
