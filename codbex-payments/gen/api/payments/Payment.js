...
const dao = require("codbex-payments/gen/dao/payments/Payment");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-payments/gen/api/Payment.js/" + entity.Id);
