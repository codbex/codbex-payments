	...
	.controller('PageController', ($scope, $http, ViewParameters, LocaleService, EntityService) => {
		...
		$scope.create = () => {
			...
			EntityService.create(entity).then((response) => {
				...
				$scope.$evalAsync(() => {
					$scope.errorMessage = LocaleService.t('codbex-payments:codbex-payments-model.messages.error.unableToCreate', { name: '$t(codbex-payments:codbex-payments-model.t.PAYMENTRECORD)', message: message });
				});
		...
		$scope.update = () => {
			...
			EntityService.update(id, entity).then((response) => {
				...
				const message = error.data ? error.data.message : '';
				$scope.$evalAsync(() => {
					$scope.errorMessage = LocaleService.t('codbex-payments:codbex-payments-model.messages.error.unableToUpdate', { name: '$t(codbex-payments:codbex-payments-model.t.PAYMENTRECORD)', message: message });
				});
				console.error('EntityService:', error);
			});
		};
		...
		$scope.servicePaymentDirection = '/services/java/codbex-payments/gen/codbex_payments/api/settings/PaymentDirectionController';
		...
		$scope.loadMoreOptionsPaymentDirection = () => {
			...
			$http.get(`/services/java/codbex-payments/gen/codbex_payments/api/settings/PaymentDirectionController?$limit=${limit}&$offset=${++loadMoreOptionsPaymentDirectionCounter * limit}`)
			.then((response) => {
		...
		$scope.servicePaymentType = '/services/java/codbex-payments/gen/codbex_payments/api/settings/PaymentTypeController';
		...
		$scope.loadMoreOptionsPaymentType = () => {
			...
			$http.get(`/services/java/codbex-payments/gen/codbex_payments/api/settings/PaymentTypeController?$limit=${limit}&$offset=${++loadMoreOptionsPaymentTypeCounter * limit}`)
			.then((response) => {
