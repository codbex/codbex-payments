...
import { PaymentRecordRepository } from '../../data/PaymentRecord/PaymentRecordRepository'
import { PaymentRecordEntity } from '../../data/PaymentRecord/PaymentRecordEntity'
...
class PaymentRecordController {
    ...
    private readonly repository!: PaymentRecordRepository;

    @Get('/')
    @Documentation('Get All PaymentRecord')
    public getAll(_: any, ctx: any): PaymentRecordEntity[] {
        try {
    ...
    public create(entity: PaymentRecordEntity): PaymentRecordEntity {
        try {
    ...
    public search(filter: any): PaymentRecordEntity[] {
        try {
            this.checkPermissions('read');
    ...
    public getById(_: any, ctx: any): PaymentRecordEntity {
        try {
            this.checkPermissions('read');
    ...
    public update(entity: PaymentRecordEntity, ctx: any): PaymentRecordEntity {
        try {
            this.checkPermissions('write');
            const id = parseInt(ctx.pathParameters.id);
            entity.Id = id;
